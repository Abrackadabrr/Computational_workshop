...
Types::scalar neumann(const Types::point_t &x) { return 0; }
...
int main() {
    ...
    mesh.LoadMSH("/home/evgen/Education/MasterDegree/5_level/Chapter_1/INM_RAS/Computing_workshop/Workshop/Lab1/"
                 "examples/Lab2/meshes/ventrical.msh");
    ...
    const auto slae =
        FEM::Assembly::getSLAE<Math::Integration::QuadratureTypes::GaussianPoints<3, 3>, FEM::FiniteElements::P1>(mesh, rhs, D, c);
    ...
    // решение методом конечных объёмов
    Mesh::Utils::assign_to_nodes(res, mesh, "numerical_solution");
    mesh.Save("/home/evgen/Education/MasterDegree/5_level/Chapter_1/INM_RAS/Computing_workshop/Workshop/Lab1/examples/"
